...
public class CoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoginButton loginButton = (LoginButton)findViewById(R.id.co_btn);
    ...
    private void nextActivity(Profile profile){
        if(profile != null){
            Intent main = new Intent(CoActivity.this, MainActivity.class);
            main.putExtra("prenom", profile.getFirstName());
            main.putExtra("nom", profile.getLastName());
